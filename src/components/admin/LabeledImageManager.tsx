...
export function LabeledImageManager({ section, slots, title, description, defaultOpen = false, columns = 3 }: LabeledImageManagerProps) {
  ...
  const gridCols = columns === 7 ? "grid-cols-2 sm:grid-cols-4 lg:grid-cols-7" : columns === 5 ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-5" : columns === 4 ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-4" : "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3";
