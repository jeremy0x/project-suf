    ...
    <Layout>
      ...
      >
        ...
        <div className="container mx-auto px-8 relative">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-4 font-crimson">About Us</h1>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <motion.div 
              ...
              transition={{ duration }}
            >
              <h2 className="section-title font-crimson">Our <span className="text-brand-blue">Story</span></h2>
      ...
      <section className="section-padding bg-brand-dark text-white diagonal-box-reverse px-8">
        <div className="container mx-auto">
          <motion.div 
            ...
            transition={{ duration }}
          >
            <h2 className="section-title font-crimson">Our <span className="text-brand-gold">Mission & Values</span></h2>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <motion.div variants={itemVariants} className="bg-gray-800/60 p-8 rounded-xl shadow-lg glass-card">
              <div className="mb-4 text-brand-gold">
                <Award size={48} />
              </div>
              <h3 className="text-xl font-bold mb-4 font-crimson">Excellence</h3>
              <p className="text-sm">
            ...
            <motion.div variants={itemVariants} className="bg-gray-800/60 p-8 rounded-xl shadow-lg glass-card">
              ...
              <h3 className="text-xl font-bold mb-4 font-crimson">Dedication</h3>
              <p className="text-sm">
          ...
          >
            <h3 className="text-2xl font-bold mb-4 font-crimson">Our Mission</h3>
            <p className="text-sm mb-6">
      ...
      <section className="section-padding bg-background px-8">
        <div className="container mx-auto">
          <motion.div 
            ...
            transition={{ duration }}
          >
            <h2 className="section-title font-crimson">Our <span className="text-brand-blue">Team</span></h2>
            <p className="section-subtitle text-sm">
            ...
            {[
              ...
              <motion.div key={index} variants={itemVariants}>
                <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:translate-y-[-5px]">
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold mb-1 font-crimson">{member.name}</h3>
      ...
      <section className="bg-brand-dark text-white py-20 relative overflow-hidden px-8">
        ...
        <div className="container mx-auto relative">
          ...
          >
            ...
            >
              <a href="/contact" className="btn-primary font-crimson">
                GET STARTED TODAY
              </a>
            </motion.div>
          </motion.div>
